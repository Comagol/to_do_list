...
class Todo_list_app(tk.Tk):
    def __init__(self):
        ...
        #set placeholder for inpu field
        ...
        #Create buttons for marking task stats
    ...
    def view_stats(self):
        ...
        for i in range(total_count):
            if tasks != "Enter your todo here...":
                self.tasks_list.insert(tk.END, tasks)
                self.tasks_list.itemconfig(tk.END, fg="orange")
